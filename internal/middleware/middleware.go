...
// RequestID adds a unique request ID to each request and attaches the optional
// X-Cache-Namespace partition key to the request context.
func RequestID() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		ctx := cachecontext.WithNamespace(c.Request.Context(), c.GetHeader(cachecontext.Header))
